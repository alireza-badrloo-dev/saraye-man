...
<div class="bg-white rounded-xl shadow-md p-6">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-xl font-bold text-gray-800">✏️ ویرایش شهر</h2>
    ...
    <form action="{{ route('admin.cities.update', $city->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-6">
            ...
            <input type="text" 
                   ...
                   class="w-full max-w-md px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition @error('name') border-red-500 @enderror"
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center gap-4">
                <div class="flex-1">
                    ...
                    <p class="text-xs text-gray-400 mt-1">برای تغییر عکس، فایل جدید انتخاب کنید</p>
                </div>
