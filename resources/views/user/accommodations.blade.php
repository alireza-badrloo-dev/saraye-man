...
@section('Mycontent')
    <div>
        ...
        <div class=" mx-1  md:mx-20 xl:mx-40 relative -mt-20">
            <h1 class="text-2xl  text-gray-800 mb-4">رزرو اقامتگاه ها</h1>
            <div
                ...
                <div class=" col-span-full lg:col-span-9 ">
                    ...
                    <div class="grid grid-cols-3 w-full gap-5 ">
                        <div class=" col-span-9 ">
                            <h1 class="text-xl  text-gray-800 mb-4">لیست اقامتگاه ها</h1>
                            <div class="flex justify-between sm:justify-start   sm:space-x-4 items-center w-full mb-4">
                                ...
                                <a class="{{ request()->is('accommodations') ? 'text-sm font-normal  p-1  sm:py-1 sm:px-2 rounded-md text-white bg-orange-500' : 'text-sm font-normal  text-gray-800 p-1  sm:py-1 sm:px-2 rounded-md hover:bg-orange-500 hover:text-white' }} "
                                    href="#">پیشفرض</a>


                                <a class="{{ request()->is('') ? 'text-sm font-normal  p-1  sm:py-1 sm:px-2 rounded-md text-white bg-orange-500' : 'text-sm font-normal  text-gray-800 p-1  sm:py-1 sm:px-2 rounded-md hover:bg-orange-500 hover:text-white' }}"
                                    href="">کمترین
                                    قیمت</a>
                                            ...
                                            <a href="{{ route('details', ['id' => $item->id]) }}" class="space-y-3">
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <p class="text-gray-400 text-xs ">از <span
                                                            ...
                                                            {{ number_format($item->rooms_min_price) }}
                                                            تومان </span>/ 1شب</p>
                                                    @php
                                                        $rating = $rating ?? 3; // یا هر نام متغیر دیگه
                                                        $full = floor($rating);
